...
Este workshop é para todas e todos os que querem aprender R ou relembrar alguns conceitos básicos de R e partilhar conhecimento também! Será possível começar logo a programar em R e a produzir alguns exemplos úteis de visualização de dados. Este é o primeiro passo para te motivar a aprender mais sobre dados e a contar boas histórias com os mesmos.

***This workshop is for everyone wanting to learn R or to refresh some basic concepts in R and to share some knowledge too! You'll be able to start right away with the R language and produce some useful data visualizations. This is a first step to motivate you to understand more about data and tell good stories with it.***
...
Este workshop tem o objectivo de apresentar a linguagem R a novos utilizadores permitindo-lhes produzir visualizações simples de dados. Quem já tenha utilizado R no passado poderá também beneficiar deste workshop ao relembrar conceitos básicos e partilhar ideias com os outros.

No fim deste workshop os participantes serão capazes de:
* compreender o que é o R e qual a sua utilidade,
* utilizar e alterar código em R para alterar o resultado da execução,
* utilizar uma base de dados específica, seleccionar variáveis e produzir visualizações dos dados.
...
**9h15 - Welcoming the guests**

**9h30 - Introducting the R-Ladies Lisbon community**

**10h - Introducing data visualization**

**10h30 - Practical exercises**

**11h15 - Coffee break!**

**11h40 - Practical exercises**

**12h30 - Closing of the workshop**
